...
export const BEBIDAS_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'poker', name: 'Poker', prices: [{ amount: 10000 }] },
  ...
  },
  {
    ...
    kitchen: 'bebidas',
    items: [
      { id: 'buchanans-18', name: 'Buchanan’s 18 Años', prices: [{ amount: 450000 }] },
      { id: 'buchanans-12', name: 'Buchanan’s 12 Años', prices: [{ amount: 280000 }] },
      { id: 'buchanans-master', name: 'Buchanan’s Máster', prices: [{ amount: 320000 }] },
      { id: 'jack-daniels-fire', name: 'Jack Daniels Fire', prices: [{ amount: 220000 }] },
      { id: 'jack-daniels-apple', name: 'Jack Daniels Apple', prices: [{ amount: 220000 }] },
      { id: 'jack-daniels-honey', name: 'Jack Daniels Honey', prices: [{ amount: 220000 }] },
      { id: 'jack-daniels-tennessee', name: 'Jack Daniels Tennessee', prices: [{ amount: 220000 }] },
      { id: 'old-parr', name: 'Old Parr', prices: [{ amount: 250000 }] },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'ginebra-gordons', name: 'Gordons', prices: [{ amount: 150000 }] },
    ],
  },
  {
    ...
    kitchen: 'bebidas',
    items: [
      { id: 'don-julio-70', name: 'Don Julio 70', prices: [{ amount: 550000 }] },
      { id: 'don-julio-reposado', name: 'Don Julio Reposado', prices: [{ amount: 400000 }] },
      { id: 'don-julio-blanco', name: 'Don Julio Blanco', prices: [{ amount: 400000 }] },
      { id: 'jimador-reposado', name: 'Jimador Reposado', prices: [{ amount: 200000 }] },
      { id: 'jimador-silver', name: 'Jimador Silver', prices: [{ amount: 200000 }] },
      { id: 'olmeca-reposado', name: 'Olmeca Reposado', prices: [{ amount: 160000 }] },
      { id: 'olmeca-silver', name: 'Olmeca Silver', prices: [{ amount: 160000 }] },
      { id: '1800-silver', name: '1800 Silver', prices: [{ amount: 350000 }] },
      { id: '1800-reposado', name: '1800 Reposado', prices: [{ amount: 350000 }] },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'jagermeister', name: 'Jagermeister', prices: [{ amount: 210000 }] },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        prices: [{ label: 'Botella', amount: 150000 }],
      },
