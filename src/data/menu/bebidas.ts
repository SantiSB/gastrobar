...
export const BEBIDAS_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'malteada-oreo', name: 'Malteada de Oreo', prices: [{ amount: 15000 }], image: 'malteada' },
      ...
      { id: 'soda-hierbabuena', name: 'Soda de hierbabuena', prices: [{ amount: 14000 }], image: 'soda-artesanal' },
      ...
      { id: 'limonada-natural', name: 'Limonada natural', prices: [{ amount: 7000 }], image: 'limonada' },
      {
        id: 'jugos-en-leche',
        name: 'Jugos en leche',
